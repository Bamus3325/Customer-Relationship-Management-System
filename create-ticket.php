...
$a=mysqli_query($con,"insert into ticket(ticket_id,email_id,subject,task_type,prioprity,ticket,status,posting_date)  values('$tid','$email','$subject','Null','$priority','$ticket','$st','$pdate')");
if($a)
{
echo "<script>alert('Thank you for Messaging us. We get to you Soon...'); window.location='view-tickets.php';</script>";
}
}
?>
...
<head>
    ...
    <meta charset="utf-8" />
    <title>CRM | Create Question</title>
